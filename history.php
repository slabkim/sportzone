...
<body class="bg-gray-100 min-h-screen flex flex-col">
    ...
    <main class="container mx-auto flex-grow p-6 max-w-4xl bg-white rounded shadow">
        ...
        <p class="mb-6"><a href="home.php" class="text-blue-600 hover:underline">Back to Home</a> | <a href="logout.php" class="text-blue-600 hover:underline">Logout</a></p>
        ...
        <table class="w-full border border-gray-300 border-collapse">
            ...
            <?php foreach ($bookings as $booking): ?>
                <tr>
                    ...
                    <td class="border border-gray-300 px-4 py-2"><?php echo $booking['payment_status'] ?? 'Not Paid'; ?></td>
                    <td class="border border-gray-300 px-4 py-2">
                        <?php if ($booking['booking_status'] === 'pending'): ?>
                        <a href="payment.php?booking_id=<?php echo $booking['id']; ?>" class="text-blue-600 hover:underline">Pay Now</a>
                        <?php else: ?>
                        -
                        <?php endif; ?>
                    </td>
